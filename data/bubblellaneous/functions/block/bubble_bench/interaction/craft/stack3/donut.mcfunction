...
execute store result score $Material3 bubblellaneous run clear @p sweet_berries{CustomModelData:85181} 0
...
execute if score $Material1 bubblellaneous matches 1.. if score $Material2 bubblellaneous matches 1.. if score $Material3 bubblellaneous matches 1.. run clear @p sweet_berries{CustomModelData:85181} 1
