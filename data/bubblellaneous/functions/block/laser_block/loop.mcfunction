...
execute if entity @p[distance=...9] run scoreboard players set $Temp bubblellaneous 1
execute positioned ~ ~-1 ~ if entity @p[distance=...9] run scoreboard players set $Temp bubblellaneous 1
