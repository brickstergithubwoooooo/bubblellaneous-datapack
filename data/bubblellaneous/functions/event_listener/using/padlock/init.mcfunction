execute unless entity @s[nbt={SelectedItem:{tag:{CustomModelData:85194}}}] run item modify entity @s weapon.offhand bubblellaneous:armor/nanoglasses/remove
execute if entity @s[nbt={SelectedItem:{tag:{CustomModelData:85194}}}] run item modify entity @s weapon.mainhand bubblellaneous:armor/nanoglasses/remove
